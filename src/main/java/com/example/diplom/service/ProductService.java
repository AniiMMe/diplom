...
public class ProductService {
    ...
    public List<Product> getAllProducts(SearchData searchData) {
        ...
        if (searchData.getSortParam() != null && !searchData.getSortParam().isEmpty()) {
            if (searchData.getHowSort().equals("asc")) {
                switch (searchData.getSortParam()) {
                    case "productId":
                        orders.add(builder.asc(root.get("productId")));
                        break;
                    case "productName":
                        orders.add(builder.asc(root.get("productName")));
                        break;
                    case "productStartdata":
                        orders.add(builder.asc(root.get("productStartdata")));
                        break;
                    case "productPrice":
                        orders.add(builder.asc(root.get("productPrice")));
                        break;
                    case "productQuantity":
                        orders.add(builder.asc(root.get("productQuantity")));
                        break;
                    case "productEnddata":
                        orders.add(builder.asc(root.get("productEnddata")));
                        break;
                    default:
                ...
                switch (searchData.getSortParam()) {
                    ...
                    case "productPrice":
                        ...
                        break;
                    case "productQuantity":
                        orders.add(builder.desc(root.get("productQuantity")));
                        break;
                    case "productEnddata":
                        orders.add(builder.desc(root.get("productEnddata")));
                        break;
        ...
        predicates.add(builder.equal(root.get("writeOff"), false));
        query.where(searchPredicate);
